...
@task_group
def image_classify_task_group(file_info_list_task, class_name:str):
    
    return image_classify_task
...
with DAG(
    ...
    classify_preprocess_task >> image_classify_task

    classify_result_task = aggregate_classify_results_task(last_tasks, class_keys=class_name)
    all_clear_temp_folder_task = clear_temp_folder_task()
    
    img_classify_init_task >> check_file_branch
    check_file_branch >> no_file_task
    check_file_branch >> file_info_list_task >> last_tasks
    last_tasks >> classify_result_task
